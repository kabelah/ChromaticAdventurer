...
import org.example.realphase2.ChromaticNumber.org.phase1.structures.GraphCharacteristics;
...
public class AlgorithmHandling {
    ...
    public static void evaluate(Graph graph) {
        ...
        if (GraphCharacteristics.complete(graph)) {
            ...
            System.out.println(" complete The exact chromatic number of this graph is: " + graph.getOrder());
            FlagClass.chromaticNumber = graph.getOrder();
            return;
        }
        ...
        if (lowerBound == lowestUpperBound) {
            ...
            FlagClass.chromaticNumber = lowerBound;
            return;
        } else
        ...
        if (finalChromaticNumber == Integer.MAX_VALUE) {
            ...
            FlagClass.chromaticNumber = finalChromaticNumber;
